...
#define SLOPE_L 1.465
#define SLOPE_R 1.472
#define INTERCEPT_L 0.065
#define INTERCEPT_R 0.072
#define SLOPE_L_REVERSE 1.504
#define SLOPE_R_REVERSE 1.439
#define INTERCEPT_L_REVERSE -0.067
#define INTERCEPT_R_REVERSE -0.074

// TODO: Decide which controller is used, open loop = 1, PID = 0
#define OPEN_LOOP 0

// Decide which odometry is used, gyro sensor fusion = 1, odometry = 0
