...
cd lib
rm -rf pico-sdk
git clone git@github.com:rob102-staff/pico-sdk.git    ## If this line doesn't work, just go to the original repo https://github.com/rob102-staff/pico-sdk and fork/clone it here
cd ..
sudo ./setup.sh
cd lib/pico-sdk
git checkout master
